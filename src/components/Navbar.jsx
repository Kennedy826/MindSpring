...
const Navbar = () => {
    ...
    const navLinks = (
        <ul className='font-medium flex flex-col md:flex-row lg: space-x-8 sm:space-x-4 space-y-2 md:space-y-0 p-4 md:p-0'>
            ...
            href="#home"
            className={`text-white ${activeSection === 'home' ? 'isActive' : ''}`}>Home</motion.a></li>
            ...
            href="#testimonials"
            className={`text-white ${activeSection === 'testimonials' ? 'isActive' : ''}`}>Testimonials</motion.a></li>
        </ul>
    )
  return (
            ...
            isOpen &&(
                  <nav className='absolute top-full left-0 w-full bg-heroBg z-20 md:hidden'>
                    <ul className='flex flex-col p-4 space-y-3'>
                        ...
                        <li className='py-2'>
                        <a href='#contact' className='text-white bg-primary hover:bg-primary/90 py-2 px-4 rounded' 
                        onClick={(e) => {
                            e.preventDefault();
                            handleCloseMenu();
                            handleScrollTo('contact');

...
const Pricing = () => {
  ...
  return (
    <div id='pricing' className='bg-[#f7f8fc] p-32'>
      <div 
      className='container mx-auto px-8'>
        ...
        className='text-center mb-12'>
          ...
          <p className='text-medium mb-12 md:w-2/3 mx-auto'>We offer best prices that suit our customers. Here are the price list for different categories. </p>
        </motion.div>
        {/* packages */}
        <div 
